...
public interface BookingService {
    ...
    List<Booking> getBookingsByBookerId(long userId, String state, int from, int size);

    List<Booking> getBookingsByIdOwnerItem(long userId, String state, int from, int size);
